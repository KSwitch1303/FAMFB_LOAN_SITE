...
const Loan = () => {
  ...
  return ( 
    <LoanContext.Provider value={{purpose, setPurpose, formnum, setFormnum, borrowAmmount, setBorrowAmmount, loanDOB, setLoanDOB, residence, setResidence, employmentStatus, setEmploymentStatus, monthlyIncome, setMonthlyIncome, zipCode, setZipCode, streetAddress, setStreetAddress, firstName, setFirstName, lastName, setLastName, email, setEmail, phoneNumber, setPhoneNumber, loanTerm, setLoanTerm, maritalStatus, setMaritalStatus}}>
      <div className="loan">
        <div className="loanheader">
      
        <h2>First Access Microfinance Bank</h2>
        </div>
